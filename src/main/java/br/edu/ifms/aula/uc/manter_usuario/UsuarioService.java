...
import br.edu.ifms.aula.uc.manter_codigo_chave.KeyCode;
import br.edu.ifms.aula.uc.manter_perfil.Perfil;
import br.edu.ifms.aula.types.Status;
...
public class UsuarioService
    ...
    public Usuario criar(UsuarioForm form,
        ...
        try {
             ...
             * informados
             */
            var optional = buscarPor(form.getEmail());
            if (optional.isPresent()) {
                var msg = "Já existe usuário cadastrado com o E-mail informado.";
