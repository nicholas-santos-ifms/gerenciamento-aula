 ...
 */
package br.edu.ifms.aula.uc.manter_usuario;

import br.edu.ifms.arch.v010.controller.AbstractLeanController;
import br.edu.ifms.aula.uc.manter_usuario.AlterarSenhaForm;
import br.edu.ifms.aula.exception.MessageDto;
import br.edu.ifms.aula.uc.manter_autenticacao.ChangePasswordRequest;
import br.edu.ifms.aula.uc.manter_autenticacao.ForgotPasswordRequest;
import br.edu.ifms.aula.uc.manter_autenticacao.UserServiceAuthenticationException;
import br.edu.ifms.aula.uc.manter_codigo_chave.KeyCodeService;
...
//    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_GERENTE')")
    ...
    public ResponseEntity<Page<UsuarioLeanDto>> listar(
        ...
        Page<Usuario> page = service.listar(nome, perfilId, status, paginacao);
